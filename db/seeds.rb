...
10.times do |idx|
  Partner.create! name: Faker::University.name << " University", country: Faker::Nation.nationality,
...
20.times do |idx|
  ...
  UserLeadEvent.create! event_id: idx + 1, user_id: Faker::Number.within(1..4)
end
